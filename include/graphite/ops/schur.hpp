...
static __global__ void count_pose_rows_per_landmark_column_kernel(
...
static __global__ void fill_schur_structure_pairs_kernel(
    const size_t *col_pointers, const size_t *row_indices,
...
static __global__ void fill_schur_mul_tuples_kernel(
    const size_t *col_pointers, const size_t *row_indices,
